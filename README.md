Untitled Word Game Pro is a Wordle clone for 8-bit Apple ][ computers. It runs on any Apple ][ with 64K. It runs under ProDOS and can be copied to a hard drive if you like that sort of thing.
